...
patient_demographics = pd.read_csv(copyTitle + "/All Patient Data/all_patient_demographics.csv")
...
patient_demographics.to_csv(copyTitle + "/All Patient Data/all_patient_data.csv")