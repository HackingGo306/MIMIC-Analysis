...
patient_data = pd.read_csv(copyTitle + '/Old Diagnosis Files/patient_diagnoses_musculoskeletal_phecode 1.2.csv')
...
# save to file
patient_data.to_csv(copyTitle + '/Old Diagnosis Files/patient_diagnoses_musculoskeletal_phecode 1.2.csv', index=False)