...
fractures = pd.read_csv(copyTitle + '/fracture_patients.csv')
...
for z in range(20):
  print("\n--------------------------------", (z + 1), "--------------------------------\n")
  max_tol = match_patients(['race', 'gender', 'age', 'weight', 'height'], ['string', 'string', 'integer', 'integer', 'integer'], [0, 0, 0.3, 1, 0.6], tolerance, 'Control Group 4/batch' + str(z + 1) + '.csv')
