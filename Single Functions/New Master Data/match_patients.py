...
bank = pd.read_csv(copyTitle + "/Master Patient Data/unique_patient_data_merged_control.csv")
...
for z in range(20):
  print("\n--------------------------------", (z + 1), "--------------------------------\n")
  max_tol = match_patients(['race', 'gender', 'age', 'weight', 'height'], ['string', 'string', 'integer', 'integer', 'integer'], [0, 0, 0.3, 1, 0.6], tolerance, 'Master Patient Data/Malunion Control Group 1/batch' + str(z + 1) + '.csv')
