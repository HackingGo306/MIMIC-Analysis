...
data = pd.read_csv(copyTitle + "/Master Patient Data/unique_patient_data_merged.csv").to_dict('records')
...
output.to_csv(copyTitle + "/Master Patient Data/unique_patient_data_merged_malunion.csv", index=False)